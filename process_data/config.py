...
class Config_HBC(object):
    def __init__(self, config_file):
        ...
        self.nhid1 = conf.getint("HBC_Model_Setup", "nhid1")
        self.nhid2 = conf.getint("HBC_Model_Setup", "nhid2")

        self.dropout = conf.getfloat("HBC_Model_Setup", "dropout")
        self.epochs = conf.getint("HBC_Model_Setup", "epochs")
        self.alpha = conf.getfloat("HBC_Model_Setup", "alpha")
        self.beta = conf.getfloat("HBC_Model_Setup", "beta")
        self.gamma = conf.getfloat("HBC_Model_Setup", "gamma")
...
class Config_MBA(object):
    def __init__(self, config_file):
        ...
        self.nhid1 = conf.getint("MBA_Model_Setup", "nhid1")
        self.nhid2 = conf.getint("MBA_Model_Setup", "nhid2")

        self.dropout = conf.getfloat("MBA_Model_Setup", "dropout")
        self.epochs = conf.getint("MBA_Model_Setup", "epochs")
        self.alpha = conf.getfloat("MBA_Model_Setup", "alpha")
        self.beta = conf.getfloat("MBA_Model_Setup", "beta")
        self.gamma = conf.getfloat("MBA_Model_Setup", "gamma")
